 ...
 * "ever highest grade" comparisons — no separate rank table needed. Used
 * because `risk_flags.risk_grade_lookup_value_id` is an environment-specific
 * FK, not a stable literal. Duplicated from beneficiary-risk/riskGrade.client.ts
