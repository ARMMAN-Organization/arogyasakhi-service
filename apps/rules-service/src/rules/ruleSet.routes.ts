...
import { createRuleSetController } from './ruleSet.controller';
 ...
 */
export function registerRuleSetRoutes(doc: DocumentedRouter, service: RuleSetService) {
  const controller = createRuleSetController(service);
