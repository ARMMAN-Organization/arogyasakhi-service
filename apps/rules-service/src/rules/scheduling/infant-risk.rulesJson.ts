 ...
 * here with a documented default rather than left unhandled — tracked
 * pending ARMMAN confirmation as GitHub issue #191:
 ...
 *
 * Not yet implemented, pending ARMMAN confirmation (issue #191):
 ...
 *    Moderate tier, but MOTHER_REGISTRATION's own field logic treats it as
 *    Severe — this pack does not read any sickle-cell field at all pending
 *    that conflict being resolved (see anc-risk.rulesJson.ts's own note,
 *    this condition is ANC/registration-scoped, not infant-visit-scoped).
 *
