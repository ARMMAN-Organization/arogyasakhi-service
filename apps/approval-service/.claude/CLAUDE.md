# approval-service — service instructions

Follow root standards in [`../../.claude/CLAUDE.md`](../../.claude/CLAUDE.md).

## Purpose
Generic supervisor approval surface.
...
## Data ownership
Owns its own `approval_requests`-family tables (see `prisma/schema.prisma`). No cross-service joins.
