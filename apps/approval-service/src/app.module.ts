...
import { ApprovalRequestModule } from './approvals/approvalRequest.module';
import { PrismaService } from './prisma/prisma.service';

@Module({
  imports: [LoggerModule.forRoot(buildLoggerOptions(appConfig.LOG_LEVEL)), ApprovalRequestModule],
