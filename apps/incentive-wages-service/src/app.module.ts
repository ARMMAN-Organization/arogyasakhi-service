...
import { IncentiveEventModule } from './incentives/incentiveEvent.module';
import { PrismaService } from './prisma/prisma.service';

@Module({
  imports: [LoggerModule.forRoot(buildLoggerOptions(appConfig.LOG_LEVEL)), IncentiveEventModule],
