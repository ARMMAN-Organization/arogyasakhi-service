...
import { createSyncBatchController } from './syncBatch.controller';
 ...
 */
export function registerSyncBatchRoutes(doc: DocumentedRouter, service: SyncBatchService) {
  const controller = createSyncBatchController(service);
