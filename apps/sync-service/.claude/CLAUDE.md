# sync-service — service instructions

Follow root standards in [`../../.claude/CLAUDE.md`](../../.claude/CLAUDE.md).

## Purpose
Idempotent offline batch upload and download, delta packaging.
...
## Data ownership
Owns its own `sync_batches`-family tables (see `prisma/schema.prisma`). No cross-service joins.
