 ...
 * the gateway. Used to scope `GET /escalations/by-sakhi/:sakhiId` to a
 * Supervisor's own roster — same convention as
 * risk-referral-service's risk-by-sakhi/sakhi.client.ts.
 */
